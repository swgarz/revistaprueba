<?php return array (
  ...
  'plugins.generic.staticPages.addStaticPage' => 'Aadñir página estática',
  ...
  'plugins.generic.staticPages.viewInstructions' => '<p>Está página será accesible en:<blockquote>{$pagesPath}</blockquote>...donde %PATH% es la ruta introducida anteriormente. <strong>Nota:</strong> dos páginas no pueden tener la misma ruta. El uso de rutas integradas en el sistema puede provocar pérdidas de acceso a funciones importantes.</p>',
  ...
  'plugins.generic.staticPages.pageDeleted' => 'Página borrada con éxito.',
