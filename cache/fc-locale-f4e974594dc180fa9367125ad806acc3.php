<?php return array (
  ...
  'manager.setup.plnSettingsDescription' => 'Clica en el enlace de Preferencias para aceptar los términos de uso de PKP PN.',
  ...
  'manager.website.archiving' => 'Archivando',
  ...
  'manager.subscriptionPolicies.expiryReminderBeforeMonths2' => 'mes(es) después del vencimiento de la suscripción.',
  'manager.distribution.access' => 'Acceso',
  'manager.settings.journalDescription' => 'Todos los ajustes específicos de la revista (cabecera, contactos, políticas, normas, filiación y soporte, categorías y series).',
  'manager.settings.publicationDescription' => 'Todos los ajustes específicos del proceso de publicación (configuración general, fases del envío, de la revisión, de la edición y de la producción, plantillas de correo).',
  'manager.settings.websiteDescription' => 'Todos los ajustes específicos de las páginas web públicas (página de inicio, apariencia, lenguaje).',
  'manager.settings.distributionDescription' => 'Todos los ajustes específicos del proceso de distribución (notificación, indexación, archivado, pago, herramientas de lectura).',
  ...
  'plugins.importexport.common.action.checkStatus' => 'Comprobar estado',
