<?php return array (
  'plugins.generic.markup.archive.badZip' => 'Error handling zipfile ({$file}): {$error}',
  'plugins.generic.markup.archive.enable' => 'Open Typesetting Stack Plugin needs to be enabled.',
  'plugins.generic.markup.archive.noArticle' => 'The article does not exist.',
  'plugins.generic.markup.archive.noArticleID' => 'Article ID is invalid or missing.',
  'plugins.generic.markup.archive.noAccessKey' => 'Access Key is invalid or missing.',
  'plugins.generic.markup.archive.noJournal' => 'Request must be linked to a journal.',
  ...
  'plugins.generic.markup.required.markupHostUser' => 'Email address is required.',
...
<p><strong>Caveats:</strong> The Open Typesetting Stack (OTS) service and associated PKP plugins are still under active development and have been released in beta mode to enable testing and feedback from interested users. It is made available on an \'as is, where is\' basis without guarantees on its suitability for any particular use. With input from users of this beta mode, this open source software system will be subject to further changes, with PKP reserving the right to determine the form that its OTS service will take in the future. If you are interested in having unlimited access to OTS, or are interested in receiving paid support for OTS, please contact us at <a href="mailto:pkp.contact@gmail.com">pkp.contact@gmail.com</a>.</p>',
  ...
  'plugins.generic.markup.settings.markupHostUser' => 'Email:',
  ...
  'plugins.generic.markup.settings.siteAuthArea' => 'Login credentials for journal-wide authentication:',
  'plugins.generic.markup.settings.userAuthArea' => 'OTS login credentials',
  'plugins.generic.markup.settings.authTypeFieldHelp' => 'Specify whether you want to use site-wide or user-specific authentication to OTS. Journal-wide authentication is simpler, allowing you to share a single administrator-level OTS email address across your entire journal. However, if you anticipate individual authors wanting to access OTS directly (rather than through OJS) and want to avoid any potential issues around blind review, you can select user-specific authentication, which requires them to each specify their own OTS email address in their OJS user preferences. Most people will want to use journal-wide authentication.',
  'plugins.generic.markup.settings.authTypeSite' => 'Journal-wide authentication',
  ...
  'plugins.generic.markup.batch' => 'OTS Backlog conversion',
  'plugins.generic.markup.batch.trigger-label' => 'Start conversion',
  'plugins.generic.markup.batch.cancel-label' => 'Cancel conversion',
  'plugins.generic.markup.batch.selected-submissions' => 'On this page, you can automatically batch-convert already-published articles from PDF or Word formats to JATS XML using PKP\'s Open Typesetting Stack, without needing to navigate to each article individually. While this will generally not produce perfect results -- the Open Typesetting Stack is normally intended to be used together with the included Texture editor to improve the quality of XML -- it should be sufficient to populate your journals\' OAI feed with structured data for harvesting purposes. The Open Typesetting Stack will return converted XML to your journals under the "Production Ready Files" stage for each article that is converted here. You can still navigate to each article individually to improve formatting with Texture after performing this batch conversion.',
  'plugins.generic.markup.batch-select-file' => 'Select a file to convert',
  'plugins.generic.markup.trigger-conversion' => 'Your conversion request is being processed.',
  'plugins.generic.markup.cancel-success' => 'Batch conversion cancelled successfully',
  'plugins.generic.markup.cancel-failure' => 'Unable to cancel batch conversion',
  'plugins.generic.markup.file-exists' => '{$file} exists! Conversion already running?',
  'plugins.generic.markup.archive-download-failure' => 'Unable to download conversion archive',
  'plugins.generic.markup.archive-extract-failure' => 'Unable to extract conversion archive',
  'plugins.generic.markup.conversion-running' => 'BATCH CONVERSION NOT RUNNING!',
  'plugins.generic.markup.journalList' => 'Below is the list of all journals enabled in this OJS install:',
  'plugins.generic.markup.invalidJournalPath' => 'The specified journal path does not exist.',
  'plugins.generic.markup.processingSubmissionText' => 'Processing submission: {$submissionTitle}',
  'plugins.generic.markup.otsJobId' => 'OTS Job #ID : {$jobId}',
  'plugins.generic.markup.ojsJobInfoId' => 'OJS JobInfo #ID : {$jobInfoId}',
  'plugins.generic.markup.otsConversionStatus' => 'OTS JOB STATUS => {$conversionStatus}',
  'plugins.generic.markup.batchSummary' => '{$submissionFoundCount} submission(s) found & {$submissionProcessedCount} processed!',
  'plugins.generic.markup.settings.credsFromConfigNotice' => 'Please note that the plugin is using login credentials from OJS config file (config.inc.php)',
  'plugins.generic.markup.settings.citationHashFromConfigNotice' => 'Please note that the plugin is using the default citation style specified in OJS config file (config.inc.php)',
  'plugins.generic.markup.unknownUser' => 'The specified user, "{$adminUser}", does not exist.',
  'plugins.generic.markup.missingJournalList' => 'ERROR: This option requires a comma-separated list of journals',
  'plugins.generic.markup.archive.noUserID' => 'User ID is invalid or missing.',
); ?>